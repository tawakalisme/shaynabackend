<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>
            <table class="tale table-bordered w-100">
                <tr>
                    <th>Nama Barang</th>
                    <th>Tipe</th>
                    <th>Harga</th>
...
<div class="row">
    ...
    <div class="col-4">
        <a href="{{ route('transactions.status', $item->id) }}?status=PENDING" class="btn btn-warning btn-block"><i class="fa fa-spinner"></i> Set PENDING</a>
    </div>
</div>